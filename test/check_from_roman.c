...
START_TEST (should_return_12_when_given_XII)
{
  ck_assert_int_eq(12, roman_numeral_to_integer("XII"));
}
END_TEST
...
START_TEST (should_return_14_when_given_XIV)
{
  ck_assert_int_eq(14, roman_numeral_to_integer("XIV"));
}
END_TEST


START_TEST (should_return_15_when_given_XV)
{
  ck_assert_int_eq(15, roman_numeral_to_integer("XV"));
}
END_TEST


START_TEST (should_return_99_when_given_XCIX)
{
  ck_assert_int_eq(99, roman_numeral_to_integer("XCIX"));
}
END_TEST


START_TEST (should_return_3999_when_given_MMMCMXCIX)
{
  ck_assert_int_eq(3999, roman_numeral_to_integer("MMMCMXCIX"));
}
END_TEST


START_TEST (should_return_3998_when_given_MMMCMXCVIII)
{
  ck_assert_int_eq(3998, roman_numeral_to_integer("MMMCMXCVIII"));
}
END_TEST
...
Suite* check_from_roman_suite(void)
{
  ...
  tcase_add_test(core, should_return_14_when_given_XIV);
  tcase_add_test(core, should_return_15_when_given_XV);
